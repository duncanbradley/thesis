...
**All experiments in this paper were pre-registered, and there are are no diversions from pre-registered experimental designs, exclusion criteria, or sample size. However, in the interest of clarity and simplicity, the reported analyses differ substantially from the over-complex pre-registered analysis plan. Therefore, the pre-registration is not discussed in the remaining portion of the paper, but can be found at <https://osf.io/9v5ps/>, for reference.**
