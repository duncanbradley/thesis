...
An exploratory analysis can examine whether data visualisation literacy *interacts with* the experimental manipulations. This analysis reveals that there was no interaction between data visualisation literacy and colour legend range: F(`r printnum(full_lint_range_literacy_NumDF`), `r printnum(full_lint_range_literacy_DenDF)`) = `r printnum(full_lint_range_literacy_F.value)`, p `r printp(full_lint_range_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(full_lint_range_literacy_Eta2_partial)`. There was no interaction between data visualisation literacy and the presence of numerical labels: F(`r printnum(full_lint_label_literacy_NumDF`), `r printnum(full_lint_label_literacy_DenDF)`) = `r printnum(full_lint_label_literacy_F.value)`, p `r printp(full_lint_label_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(full_lint_label_literacy_Eta2_partial)`. There was also no three-way-interaction between data visualisation literacy, colour legend range, and the presence of numerical labels: F(`r printnum(full_lint_range_label_literacy_NumDF`), `r printnum(full_lint_range_label_literacy_DenDF)`) = `r printnum(full_lint_range_label_literacy_F.value)`, p `r printp(full_lint_range_label_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(full_lint_range_label_literacy_Eta2_partial)`. These results indicates that the effect of the experimental manipulations did not differ as a function of participants' data visualisation literacy levels. These models employed...
...
An exploratory analysis reveals that there was no interaction between data visualisation literacy and colour legend range: F(`r printnum(both_full_lint_range_literacy_NumDF`), `r printnum(both_full_lint_range_literacy_DenDF)`) = `r printnum(both_full_lint_range_literacy_F.value)`, p `r printp(both_full_lint_range_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(both_full_lint_range_literacy_Eta2_partial)`. There was no interaction between data visualisation literacy and the presence of numerical labels: F(`r printnum(both_full_lint_label_literacy_NumDF`), `r printnum(both_full_lint_label_literacy_DenDF)`) = `r printnum(both_full_lint_label_literacy_F.value)`, p `r printp(both_full_lint_label_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(both_full_lint_label_literacy_Eta2_partial)`. There was also no three-way-interaction between data visualisation literacy, colour legend range, and the presence of numerical labels: F(`r printnum(both_full_lint_range_label_literacy_NumDF`), `r printnum(both_full_lint_range_label_literacy_DenDF)`) = `r printnum(both_full_lint_range_label_literacy_F.value)`, p `r printp(both_full_lint_range_label_literacy_p, add_equals = T)`, partial $\eta^2$ `r print_es(both_full_lint_range_label_literacy_Eta2_partial)`. These results indicates that the effect of the experimental manipulations did not differ as a function of participants' data visualisation literacy levels. These models employed...
...
add_header_above(kable(random_str(full_lint), "latex"), "full_lint")
...
add_header_above(kable(random_str(both_full_lint), "latex"), "both_full_lint")
