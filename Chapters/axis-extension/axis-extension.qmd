...
**Manipulating the upper axis limit altered the length of the bars, such that an extended axis generated shorter bars, compared to the truncated axis. For the purposes of this investigation, this should not be considered a confounding variable. Firstly, controlling for this aspect whilst manipulating the upper axis limit would entail modifying the height** **of the overall chart, which could also be considered a confound.** **Second, maintaining a consistent bar height across conditions would preclude examination of the effects of default upper limits.**
