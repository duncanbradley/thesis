...
print_formula <- function(model){
  model %>%
    formula() %>%
    # these convert it to a character string again 
    # need to convert it back to a formula
...
#                      "axis" = "axis_limit")) %>%
    simplify.formula()
  # need to add brackets back in
  # put a bracket before each '1'
  # and after each 'participant/item'
  # and change order - before or after brackets - whichever is easiest
}
```
