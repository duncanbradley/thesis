...
emtrends(e1_mag_lint, pairwise ~ cond, var = "literacy")

emmip(e1_mag_lint, cond ~ literacy, cov.reduce = range) 
```
...
emtrends(e2_mag_lint, pairwise ~ axis:denominator, var = "literacy")

emmip(e2_mag_lint, axis:denominator ~ literacy, cov.reduce = range) 
...
emtrends(e2_con_lint, pairwise ~ axis:denominator, var = "literacy")

emmip(e2_con_lint, axis:denominator ~ literacy, cov.reduce = range) 
```
