...
print_formula <- function(model){
  model %>%
    format_formula() %>%
    str_replace_all(c("formula: " = "",
                      "mag_slider.response" = "magnitude_rating", 
                      "con_slider.response" = "confidence_rating",
                      "slider.response" = "magnitude_rating", 
                      "cond" = "axis_limit", 
                      "axis" = "axis_limit")) %>%
    simplify.formula()
}
...
emmip(e1_mag_lint@model, cond ~ literacy, cov.reduce = range, CIs = T, 
