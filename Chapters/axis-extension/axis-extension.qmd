...
This interaction consisted of a decrease in  between default charts when the denominator was present in text (z = `r printnum(e2_mag_lint_defaultpres_z.ratio)`, p `r printp(e2_mag_lint_defaultpres_p.value)`), but differences at different levels of literacy when ....

This is shown in @fig-e1-mag-lint. This model employed .... The model formula was as follows: `` `r paste(print_formula(e1_mag_lint))` ``.
