...
snow <- ggplot() +
  background_image(image_read("images/snow.png")) +
  coord_fixed(ratio = 1198/1277)
...
nightingale <- ggplot() +
  background_image(image_read("images/nightingale.png")) + 
  coord_fixed(ratio = 875/1600)

minard <- ggplot() +
  background_image(image_read("images/minard.png")) +
  coord_fixed(ratio = 762/1599) +
   labs(caption = "Charles Joseph Minard's Map of Napoleon's Russian Campaign")
