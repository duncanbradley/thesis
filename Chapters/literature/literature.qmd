...
#| out-width: "500px"
snow <- ggplot() +
  background_image(image_read("literature_images/snow.png")) +
  coord_fixed(ratio = 1198/1277) +
  labs(caption = "John Snow's Map of Cholera Deaths (1855)")
nightingale <- ggplot() +
  background_image(image_read("literature_images/nightingale.png")) + 
  coord_fixed(ratio = 875/1600) +
  labs(caption = "Florence Nightingale's Rose Diagram(1857)")
minard <- ggplot() +
  background_image(image_read("literature_images/minard.png")) +
  coord_fixed(ratio = 762/1599) +
   labs(caption = "Charles Joseph Minard's Map of Napoleon's Russian Campaign")

snow #/ nightingale / minard 
```
...
df_img <- data.frame(year = c("1964", "1975", "1990"),
                     ...
                     image = "literature_images/doctor.png")
