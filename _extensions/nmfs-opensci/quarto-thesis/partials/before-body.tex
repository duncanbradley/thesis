...
\null\vskip1cm%
\text{Word Count: 47,564}

\phantom{\cite{?}} % https://tex.stackexchange.com/questions/115921/wrong-numeration-in-toc-longer-then-one-page/116014#116014
...
$if(thesis.rationale)$
\begin{rationale}
\addchaptertocentry{\rationalename} % Add the rationale to the table of contents
$if(thesis.rationale.text)$
$thesis.rationale.text$
$else$
\input{"$thesis.rationale$"}
$endif$
