...
#| fig-scap: A data visualisation used by Tufte (1986) to illustrate the 'lie-factor', originally published in the Los Angeles Times."
#| fig-cap: "A data visualisation used by Tufte (1986) to illustrate the 'lie-factor', originally published in the Los Angeles Times. The final value of 12% is a 15 percentage point decrease from the first value of 27%. However, Tufte's lie-factor of 2.8 indicates that this reduction is perceived as a 42 percentage point decrease."
knitr::include_graphics("lie-factor.png")
```
